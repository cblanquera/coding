---
name: chrisai-docs-dev-formatting
description: Use when standardizing developer-facing markdown documentation for junior developers, especially when headings, outline numbering, TOC usage, spacing, code fences, or link structure need to be normalized without changing the intended editorial flow.
---
...
`chrisai-docs-dev-onboarding` or `chrisai-docs-dev-api-reference` first.
